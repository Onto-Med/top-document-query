...
public class DateUtil {
  ...
  public static LocalDateTime getBirthdateForAge(int age, String ucumUnit) throws Exception {
    ...
    switch (ucumUnit) {
      ...
      case "mo":
        ...
        break;
      default:
        throw new Exception("Invalid date unit!");
    }
  ...
  public static BigDecimal getPeriod(LocalDateTime start, String ucumUnit) throws Exception {
